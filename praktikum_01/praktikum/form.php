            ...
            <div class="col-md-12 mt-4">
                <form method="POST" action="output.php">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                            <input name="rating" id="rating_1" type="radio" class="custom-control-input" value="young" checked="checked"> 
                            <label for="rating_1" class="custom-control-label">Young</label>
                        </div>
                        <div class="custom-control custom-radio custom-control-inline">
